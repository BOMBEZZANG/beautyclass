...
export default function InstructorApplyPage() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-pink-50 to-white pt-24 flex items-center justify-center">
    ...
    <div className="min-h-screen bg-gradient-to-b from-pink-50 to-white pt-24 pb-16">
      <div className="mx-auto max-w-2xl px-4 py-8">
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
          {/* 헤더 */}
          <div className="bg-gradient-to-r from-pink-500 to-purple-500 px-8 py-10 text-center text-white">
            <div className="text-4xl mb-3">🌸</div>
            <h1 className="text-2xl font-bold mb-1">Share Your Knowledge</h1>
            <p className="text-pink-100">뷰티 온라인 강사 등록</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="px-8 py-8 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-gray-200 px-4 py-3 focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50 transition-colors"
              />
            </div>
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <input
                  ...
                  className="flex-1 rounded-xl border border-gray-200 px-4 py-3 focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50 transition-colors"
                />
              </div>
            </div>
...
초보자도 이해하기 쉬운 실전 중심의 뷰티 강의를 제공합니다.`}
                rows={6}
                className="w-full rounded-xl border border-gray-200 px-4 py-3 focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50 transition-colors resize-none"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full mt-2 rounded-xl border border-gray-200 px-4 py-3 focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50 transition-colors"
              />
            </div>
            ...
            <button
              ...
              className="w-full rounded-full bg-gradient-to-r from-pink-500 to-purple-500 py-4 text-lg font-bold text-white hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (

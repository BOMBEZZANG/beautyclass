        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-gray-50 rounded-xl">
              ...
              <button className="w-full py-2 text-sm font-medium text-pink-500 border border-pink-200 rounded-lg hover:bg-pink-50 transition-colors">
                계좌 등록하기
              </button>
            </div>
          </div>
            ...
            <table className="w-full">
              ...
              <tfoot>
                <tr className="bg-gray-50">
                  ...
                  <td className="py-4 px-4 text-right font-bold text-pink-600">

  ...
  return (
    <div className="p-6 lg:p-8">
        ...
        {courses.length === 0 ? (
          <div className="text-center py-12">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-pink-500 to-purple-500 px-6 py-3 text-white font-medium hover:shadow-lg transition-shadow"
            >
          ...
          <div className="space-y-3">
            {courses.map((course) => (
              <div
                key={course.id}
                className="flex items-center gap-4 p-4 border border-gray-100 rounded-xl hover:border-pink-200 hover:bg-pink-50/50 transition-colors"
              >
                ...
                <Link
                  ...
                  className="flex-shrink-0 text-sm text-pink-500 hover:text-pink-600 font-medium"
                >
                  관리
                </Link>
              </div>
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
        <Link
          href="/instructor/courses/new"
          className="flex items-center gap-4 p-6 bg-gradient-to-r from-pink-500 to-purple-500 rounded-2xl text-white hover:shadow-lg transition-shadow"
        >
        ...
        <Link
          href="/instructor/courses"
          className="flex items-center gap-4 p-6 bg-white rounded-2xl border border-gray-100 hover:border-pink-200 hover:shadow-lg transition-all"
        >
          <div className="w-12 h-12 bg-pink-100 rounded-full flex items-center justify-center">

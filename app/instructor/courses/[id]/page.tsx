        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <input
              ...
              className="w-full text-xl font-bold border-0 border-b-2 border-gray-200 focus:border-pink-500 focus:ring-0 pb-2 bg-transparent"
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <textarea
              ...
              rows={6}
              className="w-full border-0 border-b-2 border-gray-200 focus:border-pink-500 focus:ring-0 resize-none bg-transparent"
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                onClick={addChapter}
                className="inline-flex items-center gap-2 px-4 py-2 bg-pink-500 text-white rounded-full text-sm font-medium hover:bg-pink-600 transition-colors"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <div className="space-y-2">
                            {chapter.lessons.map((lesson, lessonIndex) => (
                              ...
                              >
                                ...
                                >
                                  <span className="flex items-center justify-center w-6 h-6 rounded-full bg-pink-100 text-pink-600 text-xs font-bold flex-shrink-0">
                                    {lessonIndex + 1}
                                  </span>
                                  <input
                                    type="text"
                                    ...
                                    <div className="flex items-center justify-between p-3 bg-purple-50 border border-purple-200 rounded-lg">
                                      ...
                                      <button
                                        ...
                                        className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                                          lesson.is_preview ? 'bg-purple-500' : 'bg-gray-200'
                                        }`}
                                      >
                                        <span
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
            <div>
              ...
              <select
                ...
                className="w-full border border-gray-200 rounded-lg px-3 py-2 focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50"
              >
                {CATEGORIES.map(cat => (
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="relative">
              <input
                ...
                min="0"
                step="1000"
                className="w-full border border-gray-200 rounded-lg px-3 py-2 pr-10 focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50"
              />

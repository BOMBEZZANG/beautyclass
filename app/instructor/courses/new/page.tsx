        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <Link
              ...
              className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-pink-500 mb-4"
            >
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-200 px-4 py-3 focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50"
                />
              </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={addChapter}
                  className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-pink-500 to-purple-500 px-4 py-2 text-sm font-medium text-white hover:shadow-lg transition-shadow"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="space-y-4">
                  {formData.chapters.map((chapter, chapterIndex) => (
                    ...
                    >
                      {/* 챕터 헤더 */}
                      <div
                        className="flex items-center gap-3 p-4 bg-gradient-to-r from-pink-50 to-purple-50 cursor-pointer"
                        onClick={() => setExpandedChapter(expandedChapter === chapter.id ? null : chapter.id)}
                      >
                        <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-gradient-to-r from-pink-500 to-purple-500 text-white text-sm font-bold flex-shrink-0">
                          {chapterIndex + 1}
                        </span>
                        <input
                          type="text"
                          ...
                          {chapter.lessons.length === 0 ? (
                            <div className="text-center py-6 border-2 border-dashed border-gray-200 rounded-lg">
                              ...
                              <button
                                ...
                                className="inline-flex items-center gap-1 text-pink-500 font-medium hover:text-pink-600 text-sm"
                              >
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                                </svg>
                            ...
                            <div className="space-y-3">
                                ...
                                >
                                  ...
                                  <div className="space-y-3">
                                    <input
                                      ...
                                      placeholder="회차 제목 *"
                                      className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50"
                                    />
                                    ...
                                    <textarea
                                      ...
                                      rows={2}
                                      className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50 resize-none"
                                    />
                                  </div>
                                </div>
                              ))}
                              ...
                              <button
                                type="button"
                                onClick={() => addLesson(chapter.id)}
                                className="w-full py-2 border-2 border-dashed border-gray-200 rounded-lg text-gray-500 text-sm font-medium hover:border-pink-300 hover:text-pink-500 transition-colors"
                              >
                                + 회차 추가
                              </button>
                            </div>
...
- 수강 후 얻을 수 있는 것`}
                  rows={12}
                  className="w-full rounded-xl border border-gray-200 px-4 py-3 focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50 resize-none"
                />
              </div>
            </div>
          )}
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    min="0"
                    step="1000"
                    className="w-full rounded-xl border border-gray-200 px-4 py-3 pr-12 focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50"
                  />
              ...
              <div className="bg-gray-50 rounded-xl p-6 mt-8">
                ...
                <dl className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <dd className="text-pink-600 font-bold">
        ...
        <div className="flex items-center justify-between">
          ...
          {currentStep < 5 ? (
            <button
              type="button"
              onClick={nextStep}
              className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-pink-500 to-purple-500 px-8 py-3 text-white font-medium hover:shadow-lg transition-shadow"
            >
              다음
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-pink-500 to-purple-500 px-8 py-3 text-white font-medium hover:shadow-lg transition-shadow disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
                <>

      ...
      <div className="bg-white rounded-xl border p-4 mb-6">
        <div className="flex items-center gap-4">
          ...
          <select
            ...
            className="px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 text-sm"
          >
            ...
            <div key={review.id} className="bg-white rounded-xl border overflow-hidden">
              ...
              <div className="p-5">
                <div className="flex items-start gap-4">
                  {/* 사용자 아바타 */}
                  <div className="relative w-10 h-10 rounded-full overflow-hidden bg-gradient-to-br from-pink-400 to-purple-400 flex-shrink-0">
                    ...
                    <div className="bg-purple-50 rounded-lg p-4 border-l-2 border-purple-300">
                      ...
                      <div className="flex gap-2 justify-end mt-2">
                        ...
                        <button
                          ...
                          className="px-4 py-1.5 text-sm bg-purple-500 text-white rounded-lg disabled:opacity-50 hover:bg-purple-600"
                        >
                        ...
                        <div className="bg-gray-50 rounded-lg p-4">
                          ...
                          <div className="flex gap-2 justify-end mt-2">
                            ...
                            <button
                              ...
                              className="px-4 py-1.5 text-sm bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-lg disabled:opacity-50 hover:shadow-md"
                            >

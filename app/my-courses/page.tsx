                      ...
                      <div className="flex flex-col sm:flex-row">
                        ...
                        <div className="flex-1 p-5">
                          <Link href={`/courses/${item.course_id}`}>
                            <h3 className="font-semibold text-gray-900 text-lg mb-1 hover:text-pink-500 transition-colors">
                              {item.course?.title}
                            </h3>
                          </Link>
                          ...
                          <div className="mb-3">
                            <div className="flex items-center justify-between text-sm mb-1">
                              ...
                              <span className="font-medium text-pink-600">{item.progress}%</span>
                            </div>
              ...
              {cartItems.length === 0 ? (
                ...
                <div className="space-y-4">
                    ...
                    {cartItems.map((item, index) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <Link href={`/courses/${item.course_id}`}>
                            <h3 className="font-medium text-gray-900 hover:text-pink-500 transition-colors truncate">
                              {item.course?.title}
                            </h3>
                          </Link>
                  ...
                  <div className="bg-white rounded-2xl shadow-sm border p-6">
                    ...
                    <button className="w-full py-3 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-xl font-semibold hover:shadow-lg transition-shadow">
                      전체 결제하기
                    </button>
                  </div>
                </div>

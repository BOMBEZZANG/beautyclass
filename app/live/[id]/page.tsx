            ...
            {session.instructor && (
              <div className="bg-gray-800/50 rounded-xl p-6">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-pink-400 to-purple-400 flex items-center justify-center text-white font-bold overflow-hidden">

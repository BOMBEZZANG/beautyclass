    ...
    <div className="p-6 lg:p-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-gradient-to-br from-purple-600 to-purple-700 rounded-xl p-5">
          <p className="text-purple-100 text-sm mb-1">강사 정산금 (70%)</p>
      ...
      <div className="bg-gray-800 rounded-xl border border-gray-700 p-5 mb-8">
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div>
            ...
            <p className="text-xl font-bold text-purple-400">{formatCurrency(Math.round(stats.todaySales * 0.7))}</p>
          </div>
        </div>
      </div>
            ...
            <>
                  ...
                  <div key={instructor.instructor_id} className="p-4 hover:bg-gray-700/50 transition-colors">
                    <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:items-center">
                      ...
                      <div className="col-span-3 flex items-center gap-3 mb-3 lg:mb-0">
                        <div className="relative w-10 h-10 rounded-full overflow-hidden bg-gradient-to-br from-purple-500 to-pink-500 flex-shrink-0">
                      ...
                      {/* 강사 정산 */}
                      <div className="col-span-2 text-left lg:text-right mb-2 lg:mb-0">
                        <p className="text-purple-400 font-medium">{formatCurrency(instructor.instructor_payout)}</p>
                      </div>
              ...
              <div className="p-4 border-t border-gray-600 bg-gray-700/50">
                <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:items-center">
                  ...
                  <div className="col-span-2 text-right font-semibold text-purple-400">
                ...
                {recentPurchases.map((purchase) => (
                  <div key={purchase.id} className="p-4 hover:bg-gray-700/50 transition-colors">
                    <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:items-center">
                      ...
                      {/* 강사 정산 */}
                      <div className="col-span-2 text-left lg:text-right mb-2 lg:mb-0">
                        <p className="text-purple-400">{formatCurrency(Math.round(purchase.amount * (1 - COMMISSION_RATE)))}</p>
                      </div>

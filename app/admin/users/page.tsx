    ...
    <div className="p-6 lg:p-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-6 gap-4 mb-8">
        ...
        <div className="bg-gradient-to-br from-purple-600 to-purple-700 rounded-xl p-4">
          <p className="text-purple-100 text-sm mb-1">최근 30일</p>
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-4">
          ...
          <p className="text-2xl font-bold text-purple-400">{stats.instructors.toLocaleString()}</p>
        </div>
      </div>
                    ...
                    <div className="col-span-2 mb-3 md:mb-0">
                      <div className="text-sm">
                        ...
                        {user.role === 'instructor' && (
                          <p className="text-gray-400">
                            강의 <span className="text-purple-400">{user.courses_count}</span>개
                          </p>
                        )}
                      </div>
                    </div>

  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400 mt-1">뷰티클래스 관리자 센터에 오신 것을 환영합니다</p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700">
          ...
          <p className="text-purple-400 text-xs mt-2">발행 {stats.publishedCourses}개</p>
        </div>
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-5">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div>
              ...
              <p className="text-xl font-bold text-purple-400">{Math.round(stats.todayRevenue * 0.7).toLocaleString()}원</p>
            </div>
          </div>
        </div>
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-5">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div>
              <p className="text-gray-400 text-sm">강사 정산</p>
              <p className="text-xl font-bold text-purple-400">{Math.round(stats.monthRevenue * 0.7).toLocaleString()}원</p>
            </div>
          </div>
        </div>
      </div>

      ...
      <main className="pt-24 pb-12">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex flex-col items-center">
                <div className="relative">
                  {profile.avatar_url ? (
                    ...
                    <div className="w-24 h-24 rounded-full bg-gradient-to-br from-pink-400 to-purple-400 flex items-center justify-center text-white text-3xl font-bold">
                ...
                <label className="mt-3 text-sm text-pink-500 hover:text-pink-600 cursor-pointer">
                  <input
                    type="file"
                    accept="image/*"
          ...
          {profile.role === 'instructor' && instructorStats && (
            <section className="bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl shadow-sm p-6 mb-6 text-white">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {purchasedCourses.map((purchase) => (
                  <Link
                    ...
                    className="flex gap-4 p-4 rounded-xl border hover:border-pink-300 hover:shadow-md transition-all"
                  >
          ...
          {profile.role === 'student' && (
            <section className="mt-6 bg-gradient-to-r from-pink-50 to-purple-50 rounded-2xl border border-pink-200 p-6">
              <div className="flex items-center gap-4">
                ...
                <Link
                  ...
                  className="px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-full text-sm font-medium hover:shadow-lg transition-shadow"
                >
                  강사 신청하기
                </Link>
              </div>

    ...
    return (
      <div className="space-y-4">
        ...
        <button
          ...
          className="w-full rounded-full bg-gradient-to-r from-pink-500 to-purple-500 py-4 text-lg font-semibold text-white shadow-md transition-all hover:shadow-lg hover:from-pink-600 hover:to-purple-600"
        >
          강의 계속하기
        </button>
      </div>
  ...
  return (
    <div className="space-y-3">
      <button
        ...
        disabled={isProcessing}
        className="w-full rounded-full bg-gradient-to-r from-pink-500 to-purple-500 py-4 text-lg font-semibold text-white shadow-md transition-all hover:shadow-lg hover:from-pink-600 hover:to-purple-600 disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {isProcessing ? (
          <span className="flex items-center justify-center gap-2">
            <svg className="animate-spin h-5 w-5" fill="none" viewBox="0 0 24 24">
      ...
      <button
        ...
        className={`w-full rounded-full py-3 text-base font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${
          isInCart
            ...
            : 'border-2 border-gray-200 text-gray-700 hover:border-pink-300 hover:text-pink-500'
        }`}
      >
        {isCartProcessing ? (
          <span className="flex items-center justify-center gap-2">

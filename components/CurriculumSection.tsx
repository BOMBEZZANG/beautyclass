            ...
            <div key={chapter.id} className={chapterIndex > 0 ? 'border-t' : ''}>
              ...
              >
                <div className="flex items-center gap-3">
                  <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-gradient-to-r from-pink-500 to-purple-500 text-white text-sm font-bold">
                    {chapterIndex + 1}
                  </span>
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-500">
                      ...
                      {previewCount > 0 && (
                        <span className="ml-2 text-purple-600">({previewCount}개 미리보기)</span>
                      )}
                    </p>
                  </div>
                </div>

      ...
      <div className="flex items-center justify-between mb-6">
        ...
        {isPurchased && !hasReviewed && !showForm && (
          <button
            ...
            className="px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-lg text-sm font-medium hover:shadow-md transition-shadow"
          >
            리뷰 작성하기
          </button>
        )}
        ...
        <form onSubmit={handleSubmitReview} className="bg-white rounded-xl border p-6 mb-6">
          ...
          <div className="flex gap-2 justify-end">
            ...
            <button
              ...
              className="px-6 py-2 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-lg font-medium disabled:opacity-50"
            >
            ...
            <div key={review.id} className="bg-white rounded-xl border p-5">
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-3">
                  {/* 아바타 */}
                  <div className="relative w-10 h-10 rounded-full overflow-hidden bg-gradient-to-br from-pink-400 to-purple-400">
                ...
                <div className="mt-3">
                  ...
                  <div className="flex gap-2 justify-end mt-2">
                    ...
                    <button
                      ...
                      disabled={submitting}
                      className="px-4 py-1.5 text-sm bg-pink-500 text-white rounded-lg disabled:opacity-50"
                    >
                      {submitting ? '저장 중...' : '저장'}
                    </button>
                  </div>
              ...
              <div className="flex items-center gap-4 mt-4 pt-3 border-t">
                <button
                  ...
                  className={`flex items-center gap-1.5 text-sm transition-colors ${
                    review.is_liked ? 'text-pink-500' : 'text-gray-400 hover:text-pink-500'
                  }`}
                >
                  <svg
                    className="w-5 h-5"
              ...
              {replyingTo === review.id && (
                <div className="mt-4 pl-4 border-l-2 border-purple-200">
                  <textarea
                    ...
                    rows={2}
                    className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 resize-none text-sm"
                  />
                  <div className="flex gap-2 justify-end mt-2">
                    <button
                      onClick={() => {
                    ...
                    <button
                      ...
                      className="px-4 py-1.5 text-sm bg-purple-500 text-white rounded-lg disabled:opacity-50"
                    >

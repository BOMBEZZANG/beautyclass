...
export default function LessonVideoPlayer({
      ...
      <div className="relative aspect-video bg-gray-900 flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          <div className="relative">
            <div className="h-16 w-16 rounded-full border-4 border-pink-200/20"></div>
      ...
      <div className="relative aspect-video bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center">
        <div className="text-center p-8">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-pink-500 to-purple-500 px-8 py-3 font-semibold text-white hover:shadow-lg transition-all"
          >
  ...
  if (authStatus === 'not_paid') {
    return (
      <div className="relative aspect-video bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center">
        <div className="text-center p-8">
          <div className="w-20 h-20 rounded-full bg-gradient-to-br from-pink-500/20 to-purple-500/20 flex items-center justify-center mx-auto mb-6 ring-2 ring-pink-500/30">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${
              isCompleted
                ...
                : 'bg-gradient-to-r from-pink-500 to-purple-500 text-white hover:shadow-lg disabled:opacity-50'
            }`}
          >
            {isMarkingComplete ? (

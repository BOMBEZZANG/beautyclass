      ...
      <div className="p-4">
        ...
        {showInstructorInfo && session.instructor && (
          <div className="flex items-center gap-2 mb-3">
            <div className="w-6 h-6 rounded-full bg-gradient-to-br from-pink-400 to-purple-400 flex items-center justify-center text-white text-xs font-medium overflow-hidden">
          ...
          <div className="flex gap-2">
            {session.status === 'scheduled' && (
              <>
                ...
                <button
                  onClick={onStart}
                  className="flex-1 px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-lg text-sm font-medium hover:opacity-90 transition-opacity"
                >
                  시작
                </button>
              </>
            ...
            {session.status === 'live' && (
              <>
                <Link
                  href={`/instructor/live/${session.id}`}
                  className="flex-1 text-center px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-lg text-sm font-medium hover:opacity-90 transition-opacity"
                >
                  입장
                </Link>
                <button

      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link
              href="/live"
              className="flex items-center gap-1.5 text-sm font-medium text-gray-700 hover:text-pink-500 transition-colors"
            >
              ...
              <div className="relative" ref={profileMenuRef}>
                ...
                >
                  {userProfile?.avatar_url ? (
                    ...
                    <div className="w-9 h-9 rounded-full bg-gradient-to-br from-pink-400 to-purple-400 flex items-center justify-center text-white font-medium">
                    ...
                    <div className="p-4 border-b border-gray-100">
                      <div className="flex items-center gap-3">
                        {userProfile?.avatar_url ? (
                          ...
                          <div className="w-12 h-12 rounded-full bg-gradient-to-br from-pink-400 to-purple-400 flex items-center justify-center text-white text-lg font-medium">
                            {userProfile?.full_name?.charAt(0) || user.email?.charAt(0)?.toUpperCase() || '?'}
                          </div>
                        )}
